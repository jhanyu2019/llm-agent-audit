...
The harness, the battery, and the per-configuration multi-run summaries used in this report are available at \url{https://github.com/hugoii/llm-agent-audit}. A versioned Zenodo reproducibility archive will be added with the release.
